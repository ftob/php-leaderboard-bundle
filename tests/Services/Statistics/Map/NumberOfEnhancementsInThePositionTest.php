 ...
 */
class NumberOfEnhancementsInThePositionTest extends \PHPUnit_Framework_TestCase
{
    /** @var  LeaderService */
    protected $service;
    ...
    public function testExecute()
    {
        ...
        $result = $this->service->statistics()->map(new NumberOfEnhancementsInThePosition(), [
            1,
            $preLeaders
        ])->getResultMap();
